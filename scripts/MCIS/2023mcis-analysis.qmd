...
d <- readxl::read_xlsx("2023_Q2-Q4_Tableau Data.xlsx") |>
  mutate(race_ethnicity1 = if_else(
    race_ethnicity1 == "Indigenous Mexican, Central Americand or South American", 
    "(**) IM, CM, or SM", 
    race_ethnicity1),
    dispatch_requester = if_else(
      dispatch_requester == "Emergency Department or Hospital Personnel", 
      "ED or Hospital Personnel", 
      dispatch_requester),
    dispatch_requester = if_else(
      dispatch_requester == "Significant Other/Spouse of Identified Client", 
      "SO/Spouse of Identified Client", 
      dispatch_requester))
...
# d |>
#   group_by(custody) |>
#   datawizard::data_tabulate("mc_responders_1", collapse = T)
# 
# d |>
#   filter(!is.na(age) & !is.na(disposition)) |>
#   group_by(disposition) |>
#   summarize(mean_age = mean(age),
#             p25 = quantile(age, probs = .25),
#             p75 = quantile(age, probs = .75))
```
...
ggsave("report-images/q1.1.png", width = 10, height = 7)
...
ggsave("report-images/q1.2.png", width = 10, height = 7)
# 
# if(n2 > 100){
#   q1.2
# } else {
...
ggsave("report-images/q2.1.png", width = 10, height = 7)
...
ggsave("report-images/q2.2.png", width = 10, height = 7)
...
ggsave("report-images/q3.png", width = 10, height = 7)
# q3
```
...
ggsave("report-images/q4.1.png", width = 10, height = 7)
...
ggsave("report-images/q4.2.png", width = 10, height = 7)
...
ggsave("report-images/q5.1.png", width = 10, height = 7)
...
ggsave("report-images/q5.2.png", width = 10, height = 7)
...
ggsave("report-images/q6.1.png", width = 10, height = 7)
...
ggsave("report-images/q6.2.png", width = 10, height = 7)
...
ggsave("report-images/q7.1.png", width = 10, height = 7)
...
ggsave("report-images/q7.2.png", width = 10, height = 7)
...
ggsave("report-images/q8.1.png", width = 10, height = 7)
...
ggsave("report-images/q8.2.png", width = 10, height = 7)
...
ggsave("report-images/q8.3.png", width = 10, height = 7)
...
ggsave("report-images/q8.4.png", width = 10, height = 7)
...
ggsave("report-images/q8.5.png", width = 10, height = 7)
...
ggsave("report-images/q8.6.png", width = 10, height = 7)
...
ggsave("report-images/q8.7.png", width = 10, height = 7)
...
ggsave("report-images/q8.8.png", width = 10, height = 7)
...
ggsave("report-images/q9.1.png", width = 10, height = 7)
...
ggsave("report-images/q9.2.png", width = 10, height = 7)
...
ggsave("report-images/q13.1.png", width = 10, height = 7)
...
ggsave("report-images/q13.2.png", width = 10, height = 7)
...
ggsave("report-images/q15.1.png", width = 10, height = 7)
...
ggsave("report-images/q15.2.png", width = 10, height = 7)
...
ggsave("report-images/q10.1.png", width = 10, height = 7)
...
ggsave("report-images/q10.2.png", width = 10, height = 7)
...
ggsave("report-images/q11.png", width = 10, height = 7)
q11
```
...
ggsave("report-images/q12.png", width = 10, height = 7)
q12
```
...
ggsave("report-images/q14.png", width = 10, height = 7)
...
ggsave("report-images/q16.1.png", width = 10, height = 7)
...
ggsave("report-images/q16.2.png", width = 10, height = 7)
...
ggsave("report-images/q17.1.png", width = 10, height = 7)
...
ggsave("report-images/q18.1.png", width = 10, height = 7)
...
ggsave("report-images/q18.2.png", width = 10, height = 7)
# 
# d |> 
#   filter(!is.na(disposition) & !is.na(reason_for_dispatch1)) |>
...
ggsave("report-images/q19.png", width = 10, height = 7)
q19
```
